...
class Siswa extends CI_Controller {
	...
	public function index(){
		...
		$data = array ( 'title' => 'Daftar Siswa - '.$site['nama_web'],
						'siswa' => $siswa,
						'isi' 	=> 'orangtua/siswa/daftar_siswa');
	...
	public function cetak_excel() {
		$this->load->view("orangtua/siswa/laporan_excel");
	}	
	...
	public function tambah() {
		...
		$data = array(	'title'	=> 'Tambah Siswa - '.$site['nama_web'],
						...
						'isi'	=> 'orangtua/siswa/tambah_siswa');
		$this->load->view('orangtua/layout/wrapper',$data);
		}else{
				...
				redirect(base_url('staorangtuaff/siswa'));
		}}
		// Default page
		$data = array(	'title'	=> 'Tambah Siswa - '.$site['nama_web'],
						'site'	=> $site,
	...
	public function edit($id_siswa) {
		...
		$this->load->view('orangtua/layout/wrapper',$data);
				...
				$this->session->set_flashdata('sukses','Siswa Telah Diupdate');
				redirect(base_url('orangtua/siswa'));
		}}else{
