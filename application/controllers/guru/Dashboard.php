...
class Dashboard extends CI_Controller {
	...
	public function umum(){
		...
		$this->load->view('guru/layout/wrapper',$data);
			...
			redirect(base_url('guru/dashboard/umum'));
		}
	}		
	...
	public function logo() {
		...
		$this->load->view('guru/layout/wrapper',$data);
				...
				$this->konfigurasi_model->edit($data);
				$this->session->set_flashdata('sukses','Konfigurasi Telah Diupdate');
				redirect(base_url('guru/dashboard/logo'));
		}}
		// Default page
		$data = array(	'title'	=> 'Konfigurasi Logo',
						'site'	=> $site,
	...
	public function icon() {
		...
		$this->load->view('guru/layout/wrapper',$data);
				...
				$this->konfigurasi_model->edit($data);
				$this->session->set_flashdata('sukses','Konfigurasi Telah Diupdate');
				redirect(base_url('guru/dashboard/icon'));
		}}
		// Default page
		$data = array(	'title'	=> 'Konfigurasi Icon',
						'site'	=> $site,
