...
class Siswa extends CI_Controller {
	...
	public function cetak_excel() {
		$this->load->view("guru/siswa/laporan_excel");
	}	
	...
	public function kelas() {
		...
		$data = array(	'title'	=> 'Daftar Siswa',
						'kelas'	=> $kelas,
						'isi'	=> 'guru/kelas/kelas_siswa');
		$this->load->view('guru/kelas/kelas_siswa',$data);
		}else{
			$i = $this->input;
