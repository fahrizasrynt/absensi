...
<p><a class="btn btn-primary" href="<?php echo base_url('guru/siswa/tambah');?>"><i class="fa fa-plus"></i> Tambah Siswa</a>

<a class="btn btn-danger" href="<?php echo base_url('guru/siswa/cetak_pdf');?>" target="_blank">
  <i class="fa fa-print"></i> PDF</a>

<a class="btn btn-success" href="<?php echo base_url('guru/siswa/cetak_excel');?>"><i class="fa fa-print"></i> Excel</a></p>
