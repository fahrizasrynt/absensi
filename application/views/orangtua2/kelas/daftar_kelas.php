...
<div class="modal-dialog">
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo base_url('orangtua/kelas') ?>" method="post">
...
<tbody>
    ...
    <tr class="odd gradeX">
        ...
        <td class="center">
        <a href="<?php echo base_url('orangtua/kelas/edit/'.$kelas['id_kelas']) ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

        <a href="<?php echo base_url('orangtua/kelas/delete/'.$kelas['id_kelas']) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus kelas ini?')"><i class="fa fa-trash"></i></a>
