...
<form action="<?php echo base_url('orangtua/list_orangtua/tambah') ?>" method="post" enctype="multipart/form-data">
...
<div class="col-md-6">
	<h3>Data orangtua</h3><hr>
	    ...
	    <div class="form-group">
	        ...
	        <select name="jabatan" class="form-control">
	            ...
	            <option value="wakil_kepsek">Wakil Kepala Sekolah</option>	
	...
	<div class="col-md-12">
		<input type="submit" name="submit" value="Tambah Guru" class="btn btn-primary">
	</div>			
</form>