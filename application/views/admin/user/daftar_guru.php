...
<p><button class="btn btn-primary" data-toggle="modal" data-target="#tambah"><i class="fa fa-plus"></i> Tambah Guru</button></p>
...
<div class="modal-dialog">
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo base_url('admin/user/guru') ?>" method="post">
...
<tbody>
    ...
    <tr class="odd gradeX">
        ...
        <td class="center">
        <a href="<?php echo base_url('admin/user/edit_guru/'.$guru['id_guru']) ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

        <a href="<?php echo base_url('admin/user/delete_guru/'.$guru['id_guru']) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus user ini?')"><i class="fa fa-trash"></i></a>
