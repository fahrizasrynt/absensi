...
<div class="modal-dialog">
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="<?php echo base_url('admin/kelas') ?>" method="post">
...
<tbody>
    ...
    <tr class="odd gradeX">
        <td><?php echo $i; ?></td>
        <td><a href="<?php echo base_url()?>admin/siswa/index/<?php echo $kelas['id_kelas']; ?>"><?php echo $kelas['kelas']; ?></td>
        <td><?php echo $kelas['urutan'] ?></td>
        <td class="center">
        <a href="<?php echo base_url('admin/kelas/edit/'.$kelas['id_kelas']) ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

        <a href="<?php echo base_url('admin/kelas/delete/'.$kelas['id_kelas']) ?>" class="btn btn-danger" onClick="return confirm('Yakin ingin menghapus kelas ini?')"><i class="fa fa-trash"></i></a>
