...
<form action="<?php echo base_url('admin/orangtua/tambah') ?>" method="post" enctype="multipart/form-data">
...
<div class="col-md-6">
	<h3>Data orangtua</h3><hr>
	    ...
	    <div class="form-group">
		    ...
		    <input type="text" name="pendidikan" placeholder="Pendidikan" value="<?php echo set_value ('pendidikan') ?>" required class="form-control">
	    </div>		            
	    <div class="form-group">
	    ...
	    <div class="form-group">
		    ...
		    <input type="text" name="pekerjaan" placeholder="Pekerjaan" value="<?php echo set_value ('pekerjaan') ?>" required class="form-control">
	    </div>	  
	...
	<div class="col-md-12">
		<input type="submit" name="submit" value="Tambah orangtua" class="btn btn-primary">
	</div>			
</form>